...
# workspace root is — this repository IS the built-ins. Its own scripts/checks/ holds the real
# seventeen fragments, not an extra directory composed on top of a runner living elsewhere, so this
# script calls scripts/check-agents-md.sh directly against this repository ("."), with no
