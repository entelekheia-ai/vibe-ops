...
the `template-version-gate-resolves-wrong-templates-path` dossier (closed 2026-08-20; `git show 7dffec88d4d48192c4d3a0d09f24ad48d1bf4887:project/tasks/template-version-gate-resolves-wrong-templates-path.md`) carrying no
...
the `template-version-gate-resolves-wrong-templates-path` dossier (closed 2026-08-20; `git show 7dffec88d4d48192c4d3a0d09f24ad48d1bf4887:project/tasks/template-version-gate-resolves-wrong-templates-path.md`) declares no template version, so
