...
| 032 | [the ownership verb, and the configuration it writes](032-the-ownership-verb-and-the-configuration-it-writes.md) | In Progress (Track 1 drafted: RFC-0004) | RFC-0004 acceptance |
