...
[`instruction-surfaces.md`](../../references/instruction-surfaces.md#where-each-fact-goes) decides where;
`vibe-ops records norm --type style --facet policy --print` decides how it reads.
