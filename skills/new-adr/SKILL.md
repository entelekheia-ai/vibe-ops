...
- **Read `<ADR_DIR>/AGENTS.md` if it exists** — it is the authority for this repo's *numbering scheme*
  and immutability rules. Follow it over anything in this skill. If absent, use the default `NNNN` scheme
  in Step 2.
